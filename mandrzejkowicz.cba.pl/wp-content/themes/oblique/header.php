		...
		<div class="container">
			<div class="site-branding">
				...
				<?php if ( ! empty( $oblique_site_logo ) && get_theme_mod( 'logo_style', 'hide-title' ) == 'hide-title' ) : /* Show only logo */ ?>
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>"><img class="site-logo" href="http://mandrzejkowicz.cba.pl/sprawdz-sile-hasla-i-unikalnosc-nazwy-sieci/" src="http://mandrzejkowicz.cba.pl/sprawdz-sile-hasla-i-unikalnosc-nazwy-sieci/" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" /></a>
				<?php elseif ( get_theme_mod( 'logo_style', 'hide-title' ) == 'show-title' ) : ?>
					<?php if ( ! empty( $oblique_site_logo ) ) { ?>
						<a href="http://mandrzejkowicz.cba.pl/sprawdz-sile-hasla-i-unikalnosc-nazwy-sieci/" title="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>"><img class="site-logo show-title" src="<?php echo esc_url( $oblique_site_logo ); ?>" href="http://mandrzejkowicz.cba.pl/sprawdz-sile-hasla-i-unikalnosc-nazwy-sieci/" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" /></a>
					<?php } ?>
					<h1 class="site-title"><a href="http://mandrzejkowicz.cba.pl/sprawdz-sile-hasla-i-unikalnosc-nazwy-sieci/" rel="home"><?php bloginfo( 'name' ); ?></a></h1>
